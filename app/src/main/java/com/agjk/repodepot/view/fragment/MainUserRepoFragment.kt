...
class MainUserRepoFragment(var repo: List<Repos>, val avatarUrl: String, val userName: String, val userBio: String) : Fragment(), RepoAdapter.RepoDelegate {
    ...
    override fun openDetailFragment(repoName: String, repoUrl: String, repoStartCount: String) {
        val  userDetailFragment = UserDetailsFragment(avatarUrl, repoName, userBio, repoUrl, repoStartCount)
